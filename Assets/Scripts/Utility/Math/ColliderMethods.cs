...
public static class ColliderMethods
{
    ...
    public static bool ClosestPointOnSurface(Collider collider, Vector3 to, float radius, out Vector3 closestPointOnSurface)
    {
        ...
        {
            closestPointOnSurface = ColliderMethods.ClosestPointOnSurface((BoxCollider)collider, to);
            return true;
        }
        else if (collider is SphereCollider)
        {
            closestPointOnSurface = ColliderMethods.ClosestPointOnSurface((SphereCollider)collider, to);
            return true;
        }
        else if (collider is CapsuleCollider)
        {
            closestPointOnSurface = ColliderMethods.ClosestPointOnSurface((CapsuleCollider)collider, to);
            return true;
        }
        ...
        {
            closestPointOnSurface = ColliderMethods.ClosestPointOnSurface((TerrainCollider)collider, to, radius, false);
            return true;
        }
